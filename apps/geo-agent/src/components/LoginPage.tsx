    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
          ...
          <p className="text-sm text-gray-500 mb-6">Welcome to GEO Agent</p>
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-xs font-medium text-gray-600 mb-1">Email</label>
              <input type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="name@ibizz.nl" required
          ...
          <p className="text-xs text-gray-400 text-center mt-5">Use your Friday account to sign in</p>
        </div>
      </div>
    </div>
  )
