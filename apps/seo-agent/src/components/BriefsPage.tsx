...
export default function BriefsPage() {
  ...
  useEffect(() => {
    Promise.all([
      ...
      setBriefs((bRes.data ?? []) as SeoBrief[])
    ...
    <div className="flex flex-col h-full">
      <div className="px-8 py-5 border-b border-gray-100 flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">Persona-gedreven SEO content strategie per klant</p>
        </div>
        <button
      ...
      <div className="flex-1 overflow-auto px-8 py-6">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <p className="text-sm text-gray-400 mb-5">Maak je eerste SEO brief aan om persona&apos;s en content te plannen</p>
            <button
              onClick={() => setCreating(true)}
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-3 text-xs text-gray-400 pt-3 border-t border-gray-100">
                    {brief.monthly_target && <span>{brief.monthly_target}</span>}
